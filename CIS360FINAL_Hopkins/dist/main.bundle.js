...
module.exports = "<div class=\"container\">\n  <h1>Add New Census</h1>\n  <div class=\"row\">\n    <div class=\"col-md-6\">\n      <form (ngSubmit)=\"saveBook()\" #bookForm=\"ngForm\">\n        <div class=\"form-group\">\n          <label for=\"name\">Address</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"book.address\" name=\"address\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"name\">City</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"book.city\" name=\"city\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"name\">State</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"book.state\" name=\"state\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"name\">Zip</label>\n          <input type=\"number\" class=\"form-control\" [(ngModel)]=\"book.zip\" name=\"zip\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"name\">Number of people at Address</label>\n          <input type=\"number\" class=\"form-control\" [(ngModel)]=\"book.numAddr\" name=\"numAddr\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"name\">Year</label>\n          <input type=\"number\" class=\"form-control\" [(ngModel)]=\"book.year\" name=\"year\" required>\n        </div>\n        <div class=\"form-group\">\n          <label for=\"name\">Census Taker</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"book.taker\" name=\"taker\" required>\n        </div>\n        <div class=\"form-group\">\n          <button type=\"submit\" class=\"btn btn-success\" [disabled]=\"!bookForm.form.valid\">Save</button>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>\n"
